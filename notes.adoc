...
* Hiding rule (http://www.cs.technion.ac.il/users/yechiel/c{plus}{plus}-faq/hiding-rule.html[23.9], http://www.cs.technion.ac.il/users/yechiel/c{plus}{plus}-faq/protected-virtuals.html[23.3])
...
* Atomics and lock-free programming (http://preshing.com/[Preshing on Programming]), https://preshing.com/20120710/memory-barriers-are-like-source-control-operations/[memory barriers], https://preshing.com/20120930/weak-vs-strong-memory-models/[memory models], http://preshing.com/20120226/roll-your-own-lightweight-mutex/[Benaphore], https://en.wikipedia.org/wiki/ABA_problem[ABA problem], https://en.wikipedia.org/wiki/Load-link/store-conditional[Load-link/store-conditional], http://preshing.com/20120913/acquire-and-release-semantics/[acquire and release semantics] (Load-Acquire/Store-Release in the ARM Reference Manual)
