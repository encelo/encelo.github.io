...
* Covariant Return Types and "virtual constructor" (https://isocpp.org/wiki/faq/virtual-functions#virtual-ctors[20.8], https://isocpp.org/wiki/faq/abcs#copy-of-abc-via-clone[22.5], https://web.archive.org/web/20221007133759/https://www.lwithers.me.uk/articles/covariant.html[HOWTO: Covariant Return Types in C++])
...
* Substitution Failure Is Not An Error (SFINAE) (https://isocpp.org/wiki/faq/templates#templates-vs-overloading[35.11], https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus21.html#l563[21.15] of C++ Annotations)
...
* https://en.cppreference.com/w/cpp/language/ebo[Empty base optimization], https://www.cantrip.org/emptyopt.html[The "Empty Member" C++ Optimization]

==== C++11
The book "_Effective Modern C++_" by Scott Meyers is a must-have.
Chapters and items are references to this book.

* https://isocpp.org/wiki/faq/cpp11-language-classes#delegating-ctor[Delegating constructors] (supersede https://isocpp.org/wiki/faq/ctors#init-methods[10.3], https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus07.html#l147[7.4.1] of C++ Annotations)
* Rvalues (https://www.scribd.com/document/435369721/C-Rvalue-References-Explained-pdf[C++ Rvalue References Explained] by Thomas Becker, https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus03.html#l38[3.3.2] and https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus03.html#l39[3.3.3] of C{plus}{plus} Annotations)
* https://talks.petrzemek.net/Petr-Zemek_-_2016-07-01_-_Rvalue-References.pdf[Rvalue References, Move Semantics, and the Magic Thereof] by Petr Zemek (2016)
...
* https://stackoverflow.com/questions/3106110/what-is-move-semantics[Move semantics] (https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus09.html#l191[9.7] of C++ Annotations), Rule of Five
...
* Perfect forwarding (https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus22.html#l594[22.5.2] of C++ Annotations)
...
* Lambdas (Chapter 6, https://isocpp.org/wiki/faq/cpp11-language#lambda[Lambdas] in Super-FAQ, https://fbb-git.gitlab.io/cppannotations/cppannotations/html/cplusplus11.html#l256[11.12] of C++ Annotations)
...
** https://www.learncpp.com/cpp-tutorial/ref-qualifiers/[Ref qualifiers]
...
* https://gamemath.com/["_3D Math Primer for Graphics and Game Development_"] by Fletcher Dunn and Ian Parberry (2nd Ed.)
...
* Rendering pipeline
* https://mathinsight.org/thread/vector_algebra[Vector algebra] on Math Insight
...
** https://stackoverflow.com/questions/46811240/perspective-division-explanation[Perspective division explanation?]
...
* https://en.wikipedia.org/wiki/Hazard_%28computer_architecture%29[Hazard (computer architecture)] -> (RAW, WAR, WAW data hazards, https://en.wikipedia.org/wiki/Pipeline_stall[pipeline stall], register forwarding)
...
* https://www.geeksforgeeks.org/computer-organization-architecture/write-through-and-write-back-in-cache/[Write Through and Write Back in Cache]
...
==== More Topics
* https://web.archive.org/web/20210415130605/http://assemblyrequired.crashworks.org/load-hit-stores-and-the-__restrict-keyword/[Load-Hit-Stores and the `__restrict` keyword] by Elan Ruskin
...
* http://filmicworlds.com/blog/visibility-buffer-rendering-with-material-graphs/[Visibility Buffer Rendering with Material Graphs] by John Hable
...
==== Vulkan
* https://docs.vulkan.org/guide/latest/[Khronos Vulkan Guide]
** https://docs.vulkan.org/guide/latest/tile_based_rendering_best_practices.html[Tile Based Rendering (TBR) Best Practices]
* https://docs.vulkan.org/samples/latest/README.html[Khronos Vulkan Samples]
** https://docs.vulkan.org/samples/latest/samples/performance/README.html[Performance samples]
...
* https://www.howtovulkan.com/[How to Vulkan in 2026] by Sascha Willems
...
* https://www.rastergrid.com/blog/gpu-tech/2026/03/vulkan-memory-barriers-and-image-layouts-explained/[Vulkan memory barriers and image layouts explained] by RasterGrid
...
* https://chunkstories.xyz/blog/a-note-on-descriptor-indexing/[A note on Descriptor Indexing] (2019)
* https://www.khronos.org/assets/uploads/developers/library/2018-vulkan-devday/06-subgroups.pdf[Vulkan Subgroup Explained] (2018)
* https://www.khronos.org/blog/so-long-image-layouts-simplifying-vulkan-synchronisation[So Long, Image Layouts: Simplifying Vulkan Synchronization] (2025)

==== Direct3D 12
* https://www.slideshare.net/slideshow/efficient-rendering-with-directx-12-on-intel-graphics/47572150[Efficient Rendering with DirectX 12 on Intel Graphics] by Intel (2015)
* https://gpuopen.com/download/Practical_DX12_Programming_Model_and_Hardware_Capabilities.pdf[Practical DirectX 12 - Programming Model and Hardware Capabilities] by AMD & NVIDIA (GDC 2016)
* https://alextardif.com/Bindless.html[Binding Bindlessly] by Alex Tardif (2021)

==== Vulkan & Direct3D 12
* https://gpuopen.com/download/GDC2017-Wave-Programming-D3D12-Vulkan.pdf[Wave Programming in D3D12 and Vulkan] by AMD & NVIDIA (GDC 2017)
* https://gpuopen.com/download/GDC2017-D3D12-And-Vulkan-Done-Right.pdf[D3D12 & Vulkan Done Right] by AMD (GDC 2017)
* http://media.gdcvault.com/gdc2018/presentations/Sawicki_Adam_Memory%20management%20in%20Vulkan.pdf[Memory Management in Vulkan and DX12] by Adam Sawicki (GDC 2018)
* https://gpuopen.com/download/gdc-2019-agtd5-breaking-down-barriers.pdf[Breaking Down Barriers: An Intro to GPU Synchronization] by Matt Pettineo (GDC 2019)
* https://gpuopen.com/download/Surfing_the_Wavefronts.pdf[Surfing the wave(front)s with Radeon TM GPU Profiler] by AMD (GDC 2019)
...
* https://ktstephano.github.io/rendering/opengl/prog_vtx_pulling[Programmable Vertex Pulling]

==== Graphics Studies of Games
* http://www.adriancourreges.com/blog/2015/03/10/deus-ex-human-revolution-graphics-study/[Deus Ex: Human Revolution - Graphics Study] by Adrian Courreges (2015)
* http://www.adriancourreges.com/blog/2015/06/23/supreme-commander-graphics-study/[Supreme Commander - Graphics Study] by Adrian Courreges (2015)
* http://www.adriancourreges.com/blog/2015/11/02/gta-v-graphics-study/[GTA V - Graphics Study] by Adrian Courreges (2015)
* http://www.adriancourreges.com/blog/2016/09/09/doom-2016-graphics-study/[DOOM (2016) - Graphics Study] by Adrian Courreges (2016)
* http://www.adriancourreges.com/blog/2017/12/15/mgs-v-graphics-study/[Metal Gear Solid V - Graphics Study] by Adrian Courreges (2017)
* https://simoncoenen.com/blog/programming/graphics/DoomEternalStudy.html[DOOM Eternal - Graphics Study] by Simon Coenen (2020)
* http://c0de517e.blogspot.com/2020/12/hallucinations-re-rendering-of.html[Hallucinations re: the rendering of Cyberpunk 2077] by Angelo Pesce (2020)
* http://www.elopezr.com/castlevania-lords-of-shadow-2-graphics-study/[The Rendering of Castlevania Lords of Shadow 2] by Emilio López (2015)
* http://www.elopezr.com/the-rendering-of-middle-earth-shadow-of-mordor/[The Rendering of Middle Earth: Shadow of Mordor] by Emilio López (2017)
* http://www.elopezr.com/the-rendering-of-rise-of-the-tomb-raider/[The Rendering of Rise of the Tomb Raider] by Emilio López (2018)
* http://www.elopezr.com/the-rendering-of-jurassic-world-evolution/[The Rendering of Jurassic World: Evolution] by Emilio López (2021)
* http://www.elopezr.com/the-rendering-of-mafia-definitive-edition/[The Rendering of Mafia: Definitive Edition] by Emilio López (2021)
* https://www.mamoniem.com/behind-the-pretty-frames-god-of-war/[Behind the Pretty Frames: God of War] by Muhammad A. Moniem (2022)
* https://www.mamoniem.com/behind-the-pretty-frames-elden-ring/[Behind the Pretty Frames: Elden Ring] by Muhammad A. Moniem (2022)
* https://www.mamoniem.com/behind-the-pretty-frames-resident-evil/[Behind the Pretty Frames: Resident Evil] by Muhammad A. Moniem (2022)
* https://www.mamoniem.com/behind-the-pretty-frames-diablo-iv/[Behind the Pretty Frames: Diablo IV] by Muhammad A. Moniem (2023)
* https://www.mamoniem.com/behind-the-pretty-frames-detroit-become-human/[Behind the Pretty Frames: Detroit Become Human] by Muhammad A. Moniem (2024)
* https://acko.net/blog/teardown-frame-teardown/[Teardown Frame Teardown: Rendering analysis] by Steven "Acko" (2023)
* https://www.froyok.fr/blog/2024-01-breakdown-syndicate/[Breakdown: Syndicate (2012) - The greasy bloom finally demystified] by Léna "Froyok" Piquet (2024)
* https://blog.thomaspoulet.fr/posts/anno-1800-frame-analysis/[Anno 1800: Frame Analysis] by Thomas Poulet (2025)
* https://mamoniem.com/behind-the-pretty-frames-pragmata/[Behind the Pretty Frames: PRAGMATA] by Muhammad A. Moniem (2026)

==== Desktop GPUs Architecture
* https://engineering.purdue.edu/~smidkiff/KKU/files/GPUIntro.pdf[From Shader Code to a Teraflop: How Shader Cores Work (PDF)] by Kayvon Fatahalian (SIGGRAPH 2009)
...
* https://docs.amd.com/v/u/en-US/rdna4-instruction-set-architecture[AMD RDNA 4.0 Instruction Set Architecture] (2025)
* https://docs.amd.com/v/u/en-US/rdna3-shader-instruction-set-architecture-feb-2023_0[AMD RDNA 3.0 Instruction Set Architecture] (2023)
* https://docs.amd.com/v/u/en-US/rdna2-shader-instruction-set-architecture[AMD RDNA 2.0 Instruction Set Architecture] (2020)
* https://docs.amd.com/v/u/en-US/rdna-shader-instruction-set-architecture[AMD RDNA 1.0 Instruction Set Architecture] (2020)
* https://docs.amd.com/v/u/en-US/gcn3-instruction-set-architecture[AMD GCN3 Instruction Set Architecture] (2016)
* https://gpuopen.com/learn/understanding-gpu-context-rolls/[Understanding GPU context rolls]
...
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/immortalis-g925-the-fragment-prepass[Hidden Surface Removal in Immortalis-G925: The Fragment Prepass]

====== Vulkan
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/using-compute-post-processing-in-vulkan-on-mali[Using Compute Post-Processing in Vulkan on Mali] (2018)
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/vulkan-samples[Vulkan samples: Bandwidth and throughput optimizations for mobile] (2020)
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/using-asynchronous-compute-on-arm-mali-gpus[Using asynchronous compute on Arm Mali GPUs: A practical sample] (2021)
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/deferred-shading-on-mobile[Deferred shading on mobile: An API overview] (2021)
* https://www.vulkan.org/user/pages/09.events/vulkanised-2025/T18-Pete-Harris-Arm-MobileBestPractices.pdf[Vulkan Best Practices for Mobile Development] (Vulkanised 2025)
* https://developer.arm.com/community/arm-community-blogs/b/mobile-graphics-and-gaming-blog/posts/vulkan-synchronization-how-pipeline-barriers-map-to-mali-gpu-hardware[Vulkan synchronization on Mali GPUs] (2026)
