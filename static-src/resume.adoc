...
[stripes=odd]
|===
|*Email:* encelo@gmail.com|*LinkedIn:* http://www.linkedin.com/in/encelo
|===
...
* Working full-time on https://ncine.github.io/[nCine], a cross-platform 2D open source game engine
* Presentations:
** https://encelo.github.io/nCine_14Years_Presentation/[14 Years of Developing nCine] - An Open-Source 2D Game Framework
** https://encelo.github.io/nCine_JobSystem_Presentation/[The nCine Job System] - A Little Primer on Concurrency and Parallelism in C++
|===
...
* Worked full-time on https://ncine.github.io/[nCine], a cross-platform 2D open source game engine
...
a|*Description:* Worked in the Image Quality rendering team of the Frostbite engine. Some of my tasks have been:
...
a|*Description:* Worked in the Core Game Tech team on the in-house Echo engine used for games like _Dawn of Titans_ and _Clumsy Ninja_. Some of my tasks have been:
...
I also worked with the CSR2 team to migrate their building process from Ant to Gradle.
...
a|*Description:* Worked in the Middleware Graphics team in Mali Ecosystem for the Media Processing Group (MPG) to help game companies achieve the best on Mali GPUs. +
...
* Helped porting Unreal Engine 4 to ARM 64-bit
* Wrote the codebase for a Unity demo revealed at Unite 2014
* Presented sponsored sessions at GDC, Unite, and Gamelab Barcelona
* Assisted companies like Frostbite, Epic Games, Unity, and Gameloft with the ARM and Mali tools
...
|===
|*Role:* Programmer
a|*Description:* Worked as a game programmer and a multi-platform GUI programmer.

* For the game _From Cheese_ (https://www.mobygames.com/game/from-cheese[MobyGames]), I worked as an Android programmer (UI and SPen support) and as an additional Unity programmer.
* For the game _AXL: Full Boost_ (https://www.mobygames.com/game/axl-full-boost[MobyGames]), I worked on the iPhone user interface.
* For _Bang!: The Official Videogame_ (http://www.mobygames.com/game/bang[MobyGames]), I worked on the native GUI for multiple platforms and on additional gameplay programming.
...
|*Description:* During my pre-graduation internship I worked as a programmer for Raylight, an Italian multi-platform videogame software house.
I conducted a research to simulate in real-time graphics effects like bloom and rim lighting on platforms without programmable shaders.
...
=== Education
* Bachelor's Degree in Computer Science, University of Naples "Federico II", awarded 110/110 cum laude in 2009
