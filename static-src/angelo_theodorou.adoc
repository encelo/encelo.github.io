...
* Presentations: https://encelo.github.io/nCine_14Years_Presentation/[14 Years of Developing nCine],
https://encelo.github.io/nCine_JobSystem_Presentation/[The nCine Job System]
|===
...
a|*Description:* Worked in the Image Quality engine rendering team. Some of my tasks have been:
...
|===
|*Role:* Programmer
|*Description:* Worked as a game programmer and a multi-platform GUI programmer on three released titles:
